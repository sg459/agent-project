...
- **Location**: Corn Belt region, Minnesota
- **Date**: June 15, 2024 (with time series through August 1, 2024)
- **Cloud Cover**: 8-20%
...
- These are example metadata files for testing and development
- Actual Sentinel-2 imagery must be downloaded from Copernicus Data Space
